...
public class SellerController {
    ...
    @PostMapping(value="/product/insert",produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    public void InsertMultipleProducts( @RequestBody Product product,
                                         Principal principal){

        sellerServices.createTestProduct(product, principal.getName());
    }
@GetMapping("/product")
